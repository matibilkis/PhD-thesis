...
im1 = ax.contourf(xvec, xvec, wigner_out, 100, cmap=cm.RdBu, norm= mpl.colors.Normalize(-wigner_in.max(), wigner_in.max()))
...
plt.savefig(path_dir+"wigner_coh_displaced.pdf")
